 ...
 * Distributor
 * <p>
 * A distributor provides access to cloudlaunch distribution services. 
 * </p>
 * @author cmacnaug
 * @version 1.0
 */
public interface Distributor {
    ...
    /**
     * Gets a uri which can be used to connect to a cloudlaunch server
     * @return
     */
     ...
     * can then be passed to other application in the launch cloud to use via RMI. It is best practice
