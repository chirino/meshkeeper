...
public interface PluginResolver {
    ...
    public static final String BASE_DIR = "cloudlaunch.plugin.basedir";
    
    
    static final String CLOUDLAUNCH_GROUP_ID = "org.fusesource.cloudlaunch";
    static final String CLOUDLAUNCH_ARTIFACT_ID = "cloudlaunch-api";
